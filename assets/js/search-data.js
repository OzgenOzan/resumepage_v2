...
ninja.data = [{
    ...
    handler: () => {
      ...
      description: "How AI and machine learning are transforming pharmaceutical research and development",
      section: "Posts",
      handler: () => {
      ...
      description: "An overview of bioequivalence studies and their importance in pharmaceutical development",
      section: "Posts",
      handler: () => {
      ...
      description: "A technical overview of using ML models for predicting peptide properties",
      section: "Posts",
      handler: () => {
      ...
      handler: () => {
          ...
          description: "",
          section: "News",},{id: "projects-your-project-title",
