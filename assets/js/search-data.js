...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/resumepage_v2/";
          ...
          title: "cv",
          description: "This is my resume page. You can export my resume as a pdf file via the link above.",
          section: "Navigation",
          handler: () => {
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/resumepage_v2/teaching/";
          },
        },{id: "nav-people",
          title: "people",
      ...
      handler: () => {
          ...
          window.location.href = "/resumepage_v2/blog/2021/distill/";
      ...
      handler: () => {
          ...
          section: "News",handler: () => {
              window.location.href = "/resumepage_v2/news/announcement_2/";
