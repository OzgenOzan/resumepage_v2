...
authors:
  - name: Ahmet Ozan Özgen
    url: "https://ozgenozan.github.io"
    affiliations:
      name: Nobel İlaç

bibliography: 2023-12-22-ml-drug-discovery.bib

# Optionally, you can add a table of contents to your post.
# This will appear on the right side of the page.
toc:
  - name: Introduction
  - name: Methods
    subsections:
...
Machine learning approaches are revolutionizing drug discovery by enabling rapid screening of potential therapeutic compounds. In our recent work, we developed a random forest model to predict anticancer properties of antimicrobial peptides.

# Methods

## Data Collection

We compiled a dataset of 10,000 antimicrobial peptides with known properties...

## Model Architecture

The random forest classifier was built using scikit-learn with the following features:
...
- 79.5% accuracy on validation set
- 1,648 peptides with predicted anticancer activity
- Successful experimental validation of 3 lead compounds

<d-figure>
  <figure class="fake-img p-3">
...
The high predictive accuracy suggests that our approach could accelerate the discovery of dual-action peptides with both antimicrobial and anticancer properties.

# Conclusion

This work demonstrates the potential of machine learning in identifying novel therapeutic peptides, potentially reducing the time and cost of drug discovery.

## Acknowledgments

We thank our collaborators at various institutions for their contributions to this work.
